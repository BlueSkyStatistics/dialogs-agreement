...
var localization = {
    en: {
        ...
        Ref0Color: "Color (click outside color control to select)",
        Ref0LineType: "Line Type",
        label4: "Mean Difference Line",
        MeanDiffColor: "Color (click outside color control to select)",
        MeanDiffLineType: "Line Type",
        label5: "SD Reference Lines",
        SDRefLineColor: "Color (click outside color control to select)",
        SDRefLineType: "Line Type",
        label6: "Options for Confidence Intervals for Mean and SD Lines",
        ExtraCI: "Plot CIs for Primary Lines",
        CIValue: "CI Level (%)",
        label7: "Mean Diff CI",
        MeanDiffCIColor: "Color (click outside color control to select)",
        MeanDiffCILineType: "Line Type",
        label8: "SD CI",
        SDCIColor: "Color (click outside color control to select)",
